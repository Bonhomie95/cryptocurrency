...
const Homepage = () => {
  ...
  return (
    ...
    <Row>
      ...
      <Col span={12}><Statistic title="Total 24hour Volume" value={millify(globalStats.total24hVolume)}/></Col>
      <Col span={12}><Statistic title="Total Market"value={millify(globalStats.totalMarkets)}/></Col>
    </Row>
    <div className='home-heading-container'>
    <Title level={2} className="home-title">Top 10 Cryptocurrencies in the word</Title>
